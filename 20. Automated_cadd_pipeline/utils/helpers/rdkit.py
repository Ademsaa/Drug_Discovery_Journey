...
from rdkit.Chem import Draw, AllChem, Descriptors, rdFingerprintGenerator
...
def calculate_similarity_dice(mol_obj1, mol_obj2, morgan_radius=2, morgan_nbits=4096):
    ...
    morgan_fp_mol1 = morgan_generator.GetFingerprint(mol_obj1)
    morgan_fp_mol2 = morgan_generator.GetFingerprint(mol_obj2)
    dice_similarity = round(
        DataStructs.DiceSimilarity(morgan_fp_mol1, morgan_fp_mol2), 2
    )
