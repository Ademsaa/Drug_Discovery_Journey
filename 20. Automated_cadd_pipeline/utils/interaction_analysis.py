...
from .helpers import plip, py3dmol
...
class InteractionAnalysis:
    ...
    def visualize_all_interactions(self):
        """
        Visualize docking poses of all analogs, using py3Dmol.
        The docking poses are sorted by their binding affinities in a menu.

        Returns
        -------
        ipywidgets.Output
            py3Dmol viewer for all interactions.
        """
    ...
    def visualize_analog_interactions(self, cid):
        """
        Visualize interactions in the docking poses of a certain analog, using py3Dmol.
        The docking poses are sorted by their binding affinities in a menu.
        ...
        -------
        ipywidgets.Output
            py3Dmol viewer for analog interactions.
        """
    ...
    def visualize_docking_poses_interactions(self, list_of_cid_pose_nr_tuples):
        """
        Visualize interactions in a given set of docking poses, using py3Dmol.
        ...
        -------
        ipywidgets.Output
            py3Dmol viewer for docking poses interactions.
        """
    ...
    def visualize(self, fitted_master_df):
        """
        Visualize interactions in any collection of docking poses, using py3Dmol.
