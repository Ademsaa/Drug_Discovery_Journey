...
from .helpers import obabel, smina, pdb, py3dmol
...
class Docking:
    ...
    def __init__(
        ...
        for ligand in list_ligand_obj:
            ...
            raw_log = smina.dock(
                ...
                str(ligand.docking_poses_filepath.with_suffix("")),
                output_format="pdbqt",
    ...
    def visualize_analog_poses(self, cid):
        """
        Visualize docking poses of a certain analog, using py3Dmol.
    ...
    def visualize(self, fitted_master_df):
        """
        Visualize any collection of docking poses, using py3Dmol.
